import pricingBImage from "@/assets/pricingB.svg";

export const addPricingB = (editor) => {
  editor.BlockManager.add("pricing-2", {
    label: `
      <div style="text-align: center; width: 100%; height: 100%;">
        <img src="${pricingBImage}" alt="Pricing B" style="width: 100%; height: auto; border-radius: 8px;">
        <div style="margin-top: 10px;">Pricing B</div>
      </div>
    `,
    content: `
