import pricingAImage from "@/assets/pricingA.svg"; // Replace with the path to your image asset

export const addPricingA = (editor) => {
  editor.BlockManager.add("pricing-1", {
    label: `
      <div style="text-align: center; width: 100%; height: 100%;">
        <img src="${pricingAImage}" alt="Pricing A Image" style="width: 100%; height: auto; border-radius: 8px;">
        <div style="margin-top: 10px;">Pricing A</div>
      </div>
    `,
    content: `
