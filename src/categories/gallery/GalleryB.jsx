import galleryB from "@/assets/galleryB.svg";

export const addGalleryB = (editor) => {
  editor.BlockManager.add("gallery-2", {
    label: `
      <div style="text-align: center; width: 100%; height: 100%;">
        <img src="${galleryB}" alt="Gallery B" style="width: 100%; height: auto; border-radius: 8px;">
        <div style="margin-top: 10px;">Gallery B</div>
      </div>
    `,
    content: `
