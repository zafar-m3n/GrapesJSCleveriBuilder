import galleryC from "@/assets/galleryC.svg";

export const addGalleryC = (editor) => {
  editor.BlockManager.add("gallery-3", {
    label: `
      <div style="text-align: center; width: 100%; height: 100%;">
        <img src="${galleryC}" alt="Gallery C" style="width: 100%; height: auto; border-radius: 8px;">
        <div style="margin-top: 10px;">Gallery C</div>
      </div>
    `,
    content: `
