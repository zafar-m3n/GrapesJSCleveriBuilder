import teamsBImage from "@/assets/teamB.svg";

export const addTeamsB = (editor) => {
  editor.BlockManager.add("teams-2", {
    label: `
      <div style="text-align: center; width: 100%; height: 100%;">
        <img src="${teamsBImage}" alt="Teams B Image" style="width: 100%; height: auto; border-radius: 8px;">
        <div style="margin-top: 10px;">Teams B</div>
      </div>
    `,
    content: `
