import teamsAImage from "@/assets/teamA.svg";

export const addTeamsA = (editor) => {
  editor.BlockManager.add("teams-1", {
    label: `
      <div style="text-align: center; width: 100%; height: 100%;">
        <img src="${teamsAImage}" alt="Teams A Image" style="width: 100%; height: auto; border-radius: 8px;">
        <div style="margin-top: 10px;">Teams A</div>
      </div>
    `,
    content: `
