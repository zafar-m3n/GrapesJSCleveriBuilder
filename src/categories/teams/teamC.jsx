import teamsCImage from "@/assets/teamC.svg";

export const addTeamsC = (editor) => {
  editor.BlockManager.add("teams-3", {
    label: `
      <div style="text-align: center; width: 100%; height: 100%;">
        <img src="${teamsCImage}" alt="Teams C Image" style="width: 100%; height: auto; border-radius: 8px;">
        <div style="margin-top: 10px;">Teams C</div>
      </div>
    `,
    content: `
