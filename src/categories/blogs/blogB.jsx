import blogBImage from "@/assets/blogB.svg"; // Replace with your actual image path

export const addBlogB = (editor) => {
  editor.BlockManager.add("blog-2", {
    label: `
      <div style="text-align: center; width: 100%; height: 100%;">
        <img src="${blogBImage}" alt="Blog B Image" style="width: 100%; height: auto; border-radius: 8px;">
        <div style="margin-top: 10px;">Blog B</div>
      </div>
    `,
    content: `
