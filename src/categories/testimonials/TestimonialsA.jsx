import testimonialsAImage from "@/assets/testimonialA.svg";

export const addTestimonialsA = (editor) => {
  editor.BlockManager.add("testimonials-1", {
    label: `
      <div style="text-align: center; width: 100%; height: 100%;">
        <img src="${testimonialsAImage}" alt="Testimonials A Image" style="width: 100%; height: auto; border-radius: 8px;">
        <div style="margin-top: 10px;">Testimonials A</div>
      </div>
    `,
    content: `
