import statisticsBImage from "@/assets/statisticsB.svg";

export const addStatisticsB = (editor) => {
  editor.BlockManager.add("statistics-2", {
    label: `
      <div style="text-align: center; width: 100%; height: 100%;">
        <img src="${statisticsBImage}" alt="Statistics B Image" style="width: 100%; height: auto; border-radius: 8px;">
        <div style="margin-top: 10px;">Statistics B</div>
      </div>
    `,
    content: `
