import footerE from "@/assets/footerE.svg";

export const addFooterE = (editor) => {
  editor.BlockManager.add("footer-5", {
    label: `
      <div style="text-align: center; width: 100%; height: 100%;">
        <img src="${footerE}" alt="Footer E" style="width: 100%; height: auto; border-radius: 8px;">
        <div style="margin-top: 10px;">Footer E</div>
      </div>
    `,
    content: `
